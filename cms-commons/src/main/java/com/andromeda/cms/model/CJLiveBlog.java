...
public class CJLiveBlog extends BaseModel{
			...
			private boolean hideAuthorName;
			...
			public boolean isHideAuthorName() {
				return hideAuthorName;
			}
			public void setHideAuthorName(boolean hideAuthorName) {
