...
public class ArticleDao extends CmsBaseDao{
	...
	public List<Article> getSpeedNewsArticles(Integer limit) {
		Map<String, Object> params = new HashMap<>();
		params.put("limit", StrapiConstants.LIMIT);
		List<Article> speedNewsArticles =  sqlSessionTemplate.selectList("com.andromeda.cms.model.Article.GetSpeedNewsArticles", params);
		return speedNewsArticles;
	}
