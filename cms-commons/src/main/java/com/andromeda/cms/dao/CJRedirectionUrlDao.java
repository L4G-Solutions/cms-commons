...
public class CJRedirectionUrlDao extends CmsBaseDao{
	private static String MASTER_TABLE = "cms_proxy.cj_redirection_urls";
	...
	public void add(CJRedirectionUrl redirectionUrl)
	{
		...
		sqlSessionTemplate.insert("com.andromeda.cms.model.CJRedirectionUrl.Add", params);
	}
	
	public List<CJRedirectionUrl> getById(int id) {
		Map<String, Object> params = new HashMap<>();
		params.put("id", id);
		return sqlSessionTemplate.selectList("com.andromeda.cms.model.CJRedirectionUrl.GetById", params);
	}
}
